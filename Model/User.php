	...
	public static function login($email, $password)
{
    ...
    $sql = "SELECT id, nev, email, jelszo, torolt, admin FROM boroplug.vasarlo WHERE email = :email;";
    ...
    if (!$userData) {
        return "Hibás email vagy jelszó"; // email does not exist in the database
    } else {
        if ($userData->jelszo == $password && $userData->torolt != 1) {
